...
export default function RootLayout({
  ...
  return (
    ...
    >
      ...
      {/* v0 - built-with badge */}
  <div dangerouslySetInnerHTML={{ __html: `<div id="v0-built-with-button-a1bec083-d821-46de-8694-7653a80c5325" style="
...
">
<a
  href="https://v0.app/chat/api/open/built-with-v0/b_YsCRnZzNwkP"
  target="_blank"
  rel="noopener"
  style="
    color: inherit;
...
<button
  onclick="document.getElementById('v0-built-with-button-a1bec083-d821-46de-8694-7653a80c5325').style.display='none'"
